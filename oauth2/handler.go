...
type (
	...
	ClientAuthorizedHandler func(clientID string, grant GrantType) (allowed bool, err error)

	// ClientScopeHandler check the client allows to use scope
	ClientScopeHandler func(tgr *TokenGenerateRequest) (allowed bool, err error)
	...
	RefreshingScopeHandler func(tgr *TokenGenerateRequest, oldScope string) (allowed bool, err error)

	// RefreshingValidationHandler check if refresh_token is still valid. eg no revocation or other
	RefreshingValidationHandler func(ti TokenInfo) (allowed bool, err error)
	...
	ExtensionFieldsHandler func(ti TokenInfo) (fieldsValue map[string]interface{})
