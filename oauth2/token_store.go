...
func (ts *tokenStore) Create(ctx context.Context, info TokenInfo) error {
	ct := time.Now()
...
func (ts *tokenStore) getData(key string) (TokenInfo, error) {
	var ti TokenInfo
...
func (ts *tokenStore) GetByCode(ctx context.Context, code string) (TokenInfo, error) {
	return ts.getData(code)
}

// GetByAccess use the access token for token information data
func (ts *tokenStore) GetByAccess(ctx context.Context, access string) (TokenInfo, error) {
...
func (ts *tokenStore) GetByRefresh(ctx context.Context, refresh string) (TokenInfo, error) {
